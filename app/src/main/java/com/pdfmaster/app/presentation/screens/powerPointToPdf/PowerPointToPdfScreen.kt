package com.pdfmaster.app.presentation.screens.powerPointToPdf
...
private val powerPointMimeTypes = arrayOf(
...
@Composable
fun PowerPointToPdfScreen(onBack: () -> Unit, viewModel: PowerPointToPdfViewModel = hiltViewModel()) {
    ...
    Scaffold(
        ...
        Column(
            ...
            Button(onClick = { pickFileLauncher.launch(powerPointMimeTypes) }) {
